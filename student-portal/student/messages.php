    ...
    <div class="bg-white shadow-sm border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex space-x-8">
                ...
                <a href="messages.php" class="inline-flex items-center px-1 pt-1 pb-4 border-b-2 border-blue-500 text-sm font-medium text-blue-600">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-4 sm:px-0">
            ...
            <div class="mb-8">
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-800 px-6 py-4">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-indigo-100 mt-1">View messages from administrators</p>
                            </div>
                            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg px-4 py-2">
                                <span class="text-white font-medium"><?php echo count($messages); ?> Messages</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="border-t border-gray-200 pt-4">
                                        <div class="flex items-center justify-between bg-indigo-50 rounded-lg p-3">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-3">
                                                    <p class="text-sm font-medium text-indigo-900"><?php echo htmlspecialchars($message['attachment']); ?></p>
                                                    <p class="text-xs text-indigo-600">Click to download</p>
                                                </div>
                                            </div>
                                            <a href="../uploads/<?php echo htmlspecialchars($message['attachment']); ?>" 
                                               download
                                    ...
                                    <div class="border-t border-gray-200 pt-4 mt-4">
                                        <form method="POST" class="inline">
                                            ...
                                            <button type="submit" name="mark_read" 
                                                    class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-sm hover:shadow-md">
                                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php else: ?>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center animate-slide-up">
                        ...
                        <p class="text-gray-500 max-w-sm mx-auto">
                            You don't have any messages from administrators at the moment. Check back later for updates.
                        </p>
                        <div class="mt-6">
                            <a href="dashboard.php" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all duration-200">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                                </svg>
                                Back to Dashboard
