...
<body>
    <div class="header">
        <div class="container">
            <h1>Student Portal - Edit Student</h1>
            <div class="nav">
    ...
    <div class="container">
        ...
        <?php if ($student): ?>
            <div class="form-container">
                <h2>Edit Student Profile: <?php echo htmlspecialchars($student['first_name'] . ' ' . $student['last_name']); ?></h2>
                ...
                <form method="POST" onsubmit="return validateProfileUpdate()">
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        ...
                        <a href="student_detail.php?id=<?php echo $student['id']; ?>" class="btn" style="background: #6c757d; margin-left: 10px;">Back to Details</a>
                        <a href="students.php" class="btn" style="background: #6c757d; margin-left: 10px;">Back to Students</a>
                    </div>
                </form>
            </div>
        <?php else: ?>
